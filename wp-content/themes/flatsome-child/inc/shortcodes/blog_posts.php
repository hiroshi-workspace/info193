				...
				<div class="box <?php echo esc_attr($classes_box); ?> box-blog-post has-hover">
					...
					<div class="box-text <?php echo esc_attr($classes_text); ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
						<div class="box-text-inner blog-post-inner">
							...
							foreach ((get_the_category()) as $cat) {
								if ($cat->slug !== 'video') { ?>
									<?php if ((!has_post_thumbnail() && $show_date !== 'false') || $show_date == 'text') { ?><div class="post-meta date-custom is-small op-8"><i class="fa-regular fa-calendar-days"></i> <?php echo get_the_date('d-m-Y'); ?></div><?php } ?>
